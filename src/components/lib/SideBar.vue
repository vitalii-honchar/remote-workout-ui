...
<template>
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <router-link class="nav-link" :class="{ active: studentsItemActive }" :to='{ name: "students" }'>
        ...
        <li class="nav-item">
          <router-link class="nav-link" :class="{ active: workoutsItemActive }" :to='{ name: "workouts" }'>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
        ...
        <li class="nav-item">
          <router-link class="nav-link" :class="{ active: pricePlanItemActive }" :to='{ name: "prices" }'>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Price Plans</span>
          </router-link>
        </li>
      </ul>
    </div>
